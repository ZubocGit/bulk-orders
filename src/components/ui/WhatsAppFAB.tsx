...
export function WhatsAppFAB() {
  ...
  return (
    <a
      id="dn-wa"
      className="fixed bottom-6 right-6 z-50 group flex items-center gap-3 transition-transform duration-300 pointer-events-auto"
      href={whatsappUrl}
      target="_blank"
    ...
    >
      ...
      <div className="w-14 h-14 md:w-16 md:h-16 flex items-center justify-center bg-[#25D366] rounded-full shadow-xl transition-all duration-300 group-hover:scale-110 group-active:scale-95">
        <svg
